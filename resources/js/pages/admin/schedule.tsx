...
export default function Schedule({ auth, grouped, month, year, daysInMonth, firstDayOfWeek }: SchedulePageProps & { auth: { user: { id: number; name: string; email: string } } }) {
                    ...
                    <div className="mt-6">
                        <div className="mb-4 flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1 text-sm text-body-subtle hover:text-heading"
                            >
                                <X className="h-4 w-4" />
                                Tutup
                            </button>
                        ...
                        {sailingsOnDate.length === 0 ? (
                            <p className="rounded-lg bg-neutral-secondary-soft px-6 py-8 text-center text-body-subtle">
